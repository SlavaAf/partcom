...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Delivery.address'
        db.add_column(u'delivery_delivery', 'address',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='d_address', null=True, to=orm['accounts.Address']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Delivery.address'
        db.delete_column(u'delivery_delivery', 'address_id')
    ...
    models = {
        ...
        u'delivery.delivery': {
            ...
            'address': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'d_address'", 'null': 'True', 'to': u"orm['accounts.Address']"}),
        ...
        u'delivery.partindelivery': {
            ...
            'state_in_part': ('django.db.models.fields.CharField', [], {'max_length': '15'})
        }
    }

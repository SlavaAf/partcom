...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartInDelivery.state_in_part'
        db.add_column(u'delivery_partindelivery', 'state_in_part',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartInDelivery.state_in_part'
        db.delete_column(u'delivery_partindelivery', 'state_in_part')

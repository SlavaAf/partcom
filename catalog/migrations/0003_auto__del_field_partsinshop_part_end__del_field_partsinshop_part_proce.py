...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PartsInShop.is_processing'
        db.add_column(u'catalog_partsinshop', 'is_processing',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PartsInShop.is_processing'
        db.delete_column(u'catalog_partsinshop', 'is_processing')
    ...
    models = {
        ...
        u'catalog.partsinshop': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_processing': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '100'}),

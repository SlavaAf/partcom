...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Part'
        db.create_table(u'catalog_part', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('article', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
            ('title', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
        ))
        db.send_create_signal(u'catalog', ['Part'])

        # Adding model 'PartsInShop'
        db.create_table(u'catalog_partsinshop', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('part', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ps_parts', to=orm['catalog.Part'])),
            ('shop', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ps_shops', to=orm['accounts.Shop'])),
            ('count', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=100)),
        ...
        db.send_create_signal(u'catalog', ['PartsInShop'])


    def backwards(self, orm):
        # Deleting model 'Part'
        db.delete_table(u'catalog_part')

        # Deleting model 'PartsInShop'
        db.delete_table(u'catalog_partsinshop')

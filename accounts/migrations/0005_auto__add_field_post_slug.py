...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'accounts_post', 'slug',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'accounts_post', 'slug')
    ...
    models = {
        ...
        u'accounts.post': {
            ...
            'ts_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 20, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'ts_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 20, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PostComment.answer_to'
        db.alter_column(u'accounts_postcomment', 'answer_to_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.PostComment']))

    def backwards(self, orm):

        # Changing field 'PostComment.answer_to'
        db.alter_column(u'accounts_postcomment', 'answer_to_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.UserProfile']))
    ...
    models = {
        ...
        u'accounts.post': {
            ...
            'ts_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 25, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'ts_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 25, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PostComment.created'
        db.alter_column(u'accounts_postcomment', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
        # Deleting field 'Post.datetime'
        db.delete_column(u'accounts_post', 'datetime')
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PostComment.created'
        db.alter_column(u'accounts_postcomment', 'created', self.gf('django.db.models.fields.DateTimeField')())
        # Adding field 'Post.datetime'
        db.add_column(u'accounts_post', 'datetime',
    ...
    models = {
        ...
        u'accounts.post': {
            ...
            'changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 13, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'content': ('django.db.models.fields.TextField', [], {'max_length': '10000'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 13, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.ts_public'
        db.alter_column(u'accounts_post', 'ts_public', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Post.ts_public'
        db.alter_column(u'accounts_post', 'ts_public', self.gf('django.db.models.fields.DateTimeField')())
